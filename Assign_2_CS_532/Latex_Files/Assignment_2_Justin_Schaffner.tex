...
\end{MyPython}
\newpage In order to sort out unique links I created a class Unique Set with the output file from Twitter Crawler as the only command line argument:
\begin{MyBash}
