...
\end{MyBash}
Scanning through the text with comm-f with "input" as a search parameter I found a list of the names of the fields. A blog post had led me to a script called formfinder.pl , but when I tried to run it I got an error. Rather than try to fix it I just searched manually. The field names the server was expecting were firstname, lastname, email and zip.
...
I ran the program with the required URI for the test page:
\\
